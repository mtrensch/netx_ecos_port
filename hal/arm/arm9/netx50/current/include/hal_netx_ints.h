...
#define CYGNUM_HAL_INTERRUPT_GPIO31               SRT_vic_irq_status_gpio31
...
#define CYGNUM_HAL_INTERRUPT_TIMER3               SRT_vic_irq_status_timer3
#define CYGNUM_HAL_INTERRUPT_TIMER4               SRT_vic_irq_status_timer4
#define CYGNUM_HAL_INTERRUPT_DMAC                 SRT_vic_irq_status_dmac
#define CYGNUM_HAL_INTERRUPT_TRIGGERLATCH         SRT_vic_irq_status_trigger_lt
