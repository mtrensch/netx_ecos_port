...
#include <pkgconf/devs_eth_arm_netx500.h>
...
static volatile cyg_uint32*  s_pulxPECInterruptRegisters = NULL;
static volatile MIIMU_REG_T* s_ptMiiMu                   = NULL;
static PFIFO_AREA_T          s_ptFifoArea                = NULL;
...
int netxeth_control(struct eth_drv_sc *sc, unsigned long cmd, void *data, int data_length)
{
  ...
  case ETH_DRV_GET_IF_STATS:
  {
    ...
    cyg_uint32*             pulxPECRamStart = (cyg_uint32*)&ptPortInfo->pulxPECBase[REL_Adr_ram_start / sizeof(cyg_uint32)];
...
*/
  ...
  case ETH_DRV_GET_MAC_ADDRESS: 
  {
    ...
    {
      cyg_uint16* pusMAC = (cyg_uint16*)data;
      pusMAC[2] = ptPortInfo->pulxPECBase[(REL_Adr_ram_start + REL_Adr_ETHMAC_LOCAL_MAC_ADDRESS_HI) / sizeof(cyg_uint32)];
      pusMAC[1] = ptPortInfo->pulxPECBase[(REL_Adr_ram_start + REL_Adr_ETHMAC_LOCAL_MAC_ADDRESS_LO) / sizeof(cyg_uint32)] >> 16;
      pusMAC[0] = ptPortInfo->pulxPECBase[(REL_Adr_ram_start + REL_Adr_ETHMAC_LOCAL_MAC_ADDRESS_LO) / sizeof(cyg_uint32)];
    }
  }
#endif  
  default:
